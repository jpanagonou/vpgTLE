...
def simulation(
    ...
    ct.image = paths.data / f"ct_10mm.mhd" # jai utilisé ceci
    ...
    vpg_tle.size = [50, 50, 75]  # taille du CT 
    vpg_tle.spacing = [
        10,
        10,
        10,
    ...
    vpg_tle.neutr_E.active = False
    vpg_tle.prot_tof.active = False
    vpg_tle.neutr_tof.active = False
    vpg_tle.weight = False # True to obtain weighted time spectra
