...
public:
  ...
  // --- AJOUT ---
 // Permet de remplacer le generateur d'energie standard par une
 // variante specifique (ex : energie tiree par voxel pour prompt-gamma).
 // Symetrique de SetPosGenerator, suit le meme principe d'injection.
 virtual void SetEneGenerator(GateSPSEneDistribution *eg);
